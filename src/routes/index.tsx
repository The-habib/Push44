          ...
          <div className="grid lg:grid-cols-[1fr_440px] gap-14 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                ...
                <a href="#how-it-works">
                  <motion.button
                    className="flex items-center gap-2 rounded-2xl px-8 py-4 text-[15px] font-semibold text-[#6b6360] border border-[#e8e0d8] bg-white hover:border-[#f97316]/30 hover:text-[#1a1a1a] transition-colors"
                    whileHover={{ y: -1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={spring}
                  >
