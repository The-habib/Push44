      ...
      >
        ...
        <div style={{ padding: "18px 14px 16px", borderBottom: "1px solid var(--sidebar-border)" }}>
          <Link to="/dashboard" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
            ...
            <span style={{ color: "#fffefb", fontWeight: 800, fontSize: 15, letterSpacing: "-0.03em" }}>Push44</span>
          </Link>
        </div>
          ...
          <div style={{ padding: "12px 14px", borderTop: "1px solid var(--sidebar-border)" }}>
            ...
            >
              <img
                ...
                style={{ width: 28, height: 28, borderRadius: "50%", background: "#2f2320", flexShrink: 0 }}
